...
def get_api_client() -> ApiClient:
    # On récupère dynamiquement l'URL fournie par Docker (ou localhost si lancé en local)
...
def get_ws_client() -> ClusterWSClient:
    base_url = os.environ.get("API_BASE_URL", "http://localhost:8000")
    # On transforme dynamiquement la route HTTP en route WebSocket
    ws_url = base_url.replace("http://", "ws://") + "/ws/cluster"
